//dummy YALP playlist to force customization to load
...
var dummy = module.exports = new Playlist({auto_collect: false}); //{auto_play: false && true, loop: 2, xspeed: 10, folder: 'my-projects/songs/xmas'});
